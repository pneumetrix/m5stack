...
void RTC::WriteReg(uint8_t reg, uint8_t data)
{
    ...
    */
    mgos_i2c_write_reg_b(mgos_i2c_get_global(),RTC_ADDR,reg,data);
}
...
uint8_t RTC::ReadReg(uint8_t reg)
{
    ...
    return Wire1.read();
    */
    return mgos_i2c_read_reg_b(mgos_i2c_get_global(),RTC_ADDR,reg);
}
...
void RTC::GetBm8563Time(void)
{
    ...
    */
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),RTC_ADDR,0x02,7,&trdata[0]);
    DataMask();
    Bcd2asc();
    Str2Time();
}
...
void RTC::GetTime(RTC_TimeTypeDef *RTC_TimeStruct)
{
    ...
    */
    ...
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),RTC_ADDR,0x02,3,&buf[0]);
...
void RTC::SetTime(RTC_TimeTypeDef *RTC_TimeStruct)
{
    ...
    Wire1.endTransmission();
    */
    uint8_t buf[3] =   {ByteToBcd2(RTC_TimeStruct->Seconds),
                        ByteToBcd2(RTC_TimeStruct->Minutes),
                        ByteToBcd2(RTC_TimeStruct->Hours)};
    mgos_i2c_write_reg_n(mgos_i2c_get_global(),RTC_ADDR,0x02,3,&buf[0]);
...
void RTC::GetDate(RTC_DateTypeDef *RTC_DateStruct)
{
    ...
    */
    ...
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),RTC_ADDR,0x05,4,&buf[0]);
...
{       
    ...
    buf[0] = ByteToBcd2(RTC_DateStruct->Date);
    buf[1] = ByteToBcd2(RTC_DateStruct->WeekDay);

    if (RTC_DateStruct->Year < 2000){
        buf[2] = ByteToBcd2(RTC_DateStruct->Month) | 0x80;
        buf[3] = ByteToBcd2((uint8_t)(RTC_DateStruct->Year % 100));
    }else{
        buf[2] = ByteToBcd2(RTC_DateStruct->Month) | 0x00;
        buf[3] = ByteToBcd2((uint8_t)(RTC_DateStruct->Year % 100));
    }
    ...
    Wire1.endTransmission();
    */
    mgos_i2c_write_reg_n(mgos_i2c_get_global(),RTC_ADDR,0x05,4,&buf[0]);
}
