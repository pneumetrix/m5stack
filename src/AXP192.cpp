...
void AXP192::begin()
{
    ...
    */
    ...
    //SetAxpPriphPower(1);
    //LOG(LL_INFO, ("axp: lcd_logic and sdcard power enabled\n"));
...
void AXP192::Write1Byte(uint8_t Addr, uint8_t Data)
{
    ...
    */
    mgos_i2c_write_reg_b(mgos_i2c_get_global(),AXP_ADDR,Addr,Data);
}
...
uint8_t AXP192::Read8bit(uint8_t Addr)
{
    ...
    return Wire1.read();
    */
    return mgos_i2c_read_reg_b(mgos_i2c_get_global(),AXP_ADDR,Addr);
}
...
uint16_t AXP192::Read12Bit(uint8_t Addr)
{
    ...
    uint8_t buf[2];
    //ReadBuff(Addr, 2, buf);
    buf[0] = mgos_i2c_read_reg_b(mgos_i2c_get_global(),AXP_ADDR,Addr);
    buf[1] = mgos_i2c_read_reg_b(mgos_i2c_get_global(),AXP_ADDR,Addr+1);
    Data = ((buf[0] << 4) + buf[1]); //
    return Data;
}
...
uint16_t AXP192::Read16bit(uint8_t Addr)
{
    ...
    return ReData;
    */
    return mgos_i2c_read_reg_w(mgos_i2c_get_global(),AXP_ADDR,Addr);
}
...
uint32_t AXP192::Read24bit(uint8_t Addr)
{
    ...
    */
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),AXP_ADDR,Addr,3,&(buf[0]));
    for (int i = 0; i < 3; i++)
    {
        ReData <<= 8;
        ReData |= buf[i];
...
uint32_t AXP192::Read32bit(uint8_t Addr)
{
    ...
    */
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),AXP_ADDR,Addr,4,&(buf[0]));
    for (int i = 0; i < 4; i++)
    {
        ReData <<= 8;
        ReData |= buf[i];
...
void AXP192::ReadBuff(uint8_t Addr, uint8_t Size, uint8_t *Buff)
{
    ...
    */
    mgos_i2c_read_reg_n(mgos_i2c_get_global(),AXP_ADDR,Addr,Size,Buff);
}
